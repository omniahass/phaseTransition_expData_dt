...
#include <mex.h>
#include <lapack.h>
inline void spevd(char* jobz, char* uplo, ptrdiff_t* n, float* ap, float* w, float* z, ptrdiff_t* ldz, float* work, ptrdiff_t *lwork, ptrdiff_t* iwork, ptrdiff_t* liwork, ptrdiff_t* info) { sspevd(jobz, uplo, n, ap, w, z, ldz, work, lwork, iwork, liwork, info); }
inline void spevd(char* jobz, char* uplo, ptrdiff_t* n, double* ap, double* w, double* z, ptrdiff_t* ldz, double* work, ptrdiff_t *lwork, ptrdiff_t* iwork, ptrdiff_t* liwork, ptrdiff_t* info) { dspevd(jobz, uplo, n, ap, w, z, ldz, work, lwork, iwork, liwork, info); }
